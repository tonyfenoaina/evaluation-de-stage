...
<%@page import="com.example.demo.model.Panier" %>
          ...
          <div class="top-cart-content-wrapper">
            <div class="top-cart-content">
              <ul class="scroller" style="height: 250px;">
                <li>
                  <a href="shop-item.html"><img src="ecommerce/assets/pages/img/cart-img.jpg" alt="Rolex Classic Watch" width="37" height="34"></a>
          ...
          <div class="row margin-bottom-40">
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <div class="goods-page">
                <div class="goods-data clearfix">
                  ...
                  <table summary="Shopping cart">
                    <tr>
                     ...
                     ArrayList<Panier> tabpanier = new ArrayList();
                      tabpanier = (ArrayList<Panier>)session.getAttribute("list");
                     //tabnom = (ArrayList)session.getAttribute("nom");

                     String snom = session.getAttribute("nom").toString();
                     String sprix = session.getAttribute("prix").toString();
                     String sqtt = session.getAttribute("qtt").toString();


                     
                     String[]tabnom = session.getAttribute("nom").toString().split(",");
                     String[]prix = session.getAttribute("prix").toString().split(",");
                     String[]tqtt = session.getAttribute("qtt").toString().split(",");

                    // String[] a = session.getAttribute("nom").toString().;
                      %>

                      <script>
                        console.log("haaaaa <%= snom %>");
                        localStorage.setItem('panier', '<%= snom %>');
                        localStorage.setItem('prix', '<%= sprix %>');
                        localStorage.setItem('qtt', '<%= sqtt %>');
    
                     </script>

                      <%

                    for (int index = 0; index < tabpanier.size(); index++) {
                    ...
                    <tr>
                      <td class="goods-page-image">
                        <a href="javascript:;"><img src="ecommerce/assets/pages/img/products/model3.jpg" alt="Berry Lace Dress"></a>
                      </td>
                      <td class="goods-page-description">
                        <h3><a href="javascript:;"><%= tabpanier.get(index).getNom() %></a></h3>
                      ...
                      <td class="goods-page-quantity">
                        <div class="product-quantity">
                          ...
                          <script>
                            console.log("aonaaaaa <%= index %>");
                            document.write("<input type='hidden' id='index<%= index %>' value='<%= index %>'>");
                          </script>
                           
                        </div>

                        <%= tabpanier.get(index).getQuantite() %>
                      </td>

                      <td class="goods-page-price">
                        <strong id=""><span>$</span><%= tabpanier.get(index).getPrix() %></strong>
                      </td>
                      <td class="goods-page-total">
                        <strong id="total<%= index %>"><span>$</span></strong>
                      </td>
                  ...
                  <input id='nom' type='hidden' name='nom' value="<%=tabpanier.get(index).getNom() %>>">
                  <input id='nom' type='hidden' name='idproduit' value="<%=tabpanier.get(index).getIdProduit() %>">
                  <input id='nom' type='hidden' name='prix' value="<%=tabpanier.get(index).getPrix() %>">
                   <input id='nom' type='hidden' name='qtt' value="<%=tabpanier.get(index).getQuantite() %>">
                  <script>
                ...
                <a href="/client"><button class="btn btn-default">Continue shopping <i class="fa fa-shopping-cart"></i></button></a>
