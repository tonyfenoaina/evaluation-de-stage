                  ...
                  <div id="checkout-content" class="panel-collapse collapse in">
                    <div class="panel-body row">
                      <div class="col-md-6 col-sm-6">
                        <h3>Ajouter dans le pf virtuelle</h3>
                        <p>I am a returning customer.</p>
                        <form method="get" role="form" action="/ajoutpf">
                          <div class="form-group">
                            <label for="email-login">Montant</label>
                            <input name="montant" type="number" id="email-login" class="form-control">
