  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item" class="active">
        <a class="nav-link collapsed" class="active" href="/listProduitAdmin">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/newProduit">
                ...
                %>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a href="/deleteTarif?id=<%=list.get(i).getId()%>"><button>Supprimer</button></a></td>
