...
<%@page import="com.example.demo.model.Detailstock" %>
            ...
            <form action="/cart" method="get">
              <script type="text/javascript">
               ...
               // document.getElementById("nom").value = localStorage.getItem('panier');
                ...
                document.write("<input id='prix' type='hidden' name='prix' value='"+prix+"'>")
                </script> 
    ...
    <div class="main">
        <div class="container">
          ...
          <div class="row margin-bottom-40">
            ...
            <!-- BEGIN CONTENT -->
            <%
            ArrayList<Detailstock> list = new ArrayList<Detailstock>();
                list = (ArrayList<Detailstock>)session.getAttribute("ficheProduit");    
                double entree = list.get(0).getEntree();
                double sortie = list.get(0).getSortie(); 
                int idP = list.get(0).getId();             
                double qtt = entree - sortie;               
            %>
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <div class="product-main-image">
                      <img src="ecommerce/assets/pages/img/products/model7.jpg" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="assets/pages/img/products/model7.jpg">
                    </div>
                  </div>
                  <div class="col-md-6 col-sm-6">
                    <h1><%= list.get(0).getNom() %>></h1>
                    <div class="price-availability-block clearfix">
                      <div class="price">
                        <strong><span>$</span><%= list.get(0).getPrix() %></strong>
                        <em>$<span>62.00</span></em>
                      </div>
                      <div class="availability">
                        Quantite restant: <strong><%= qtt %>></strong>
                      </div>
                      <form action="/ajoutPanier" method="get">
                        Quantite :
                          <input type="number" name="quantite" value="">
                          <input type="hidden" name="nom" value="<%= list.get(0).getNom() %>">
                          <input type="hidden" name="prix" value="<%= list.get(0).getPrix() %>">
                          <input type="hidden" name="id" value="<%= list.get(0).getId() %>">
                          <input type="hidden" name="type" value="tsotra">
