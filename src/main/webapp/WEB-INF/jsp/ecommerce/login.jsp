                  ...
                  <div id="checkout-content" class="panel-collapse collapse in">
                    <div class="panel-body row">
                      ...
                      <div class="col-md-6 col-sm-6">
                        ...
                        <form method="post" role="form" action="/loginClient">
                          <div class="form-group">
                            <label for="email-login">E-Mail</label>
                            <input name="nom" type="text" id="email-login" class="form-control">
                          </div>
                          <div class="form-group">
                            <label for="password-login">Password</label>
                            <input name="mdp" type="password" id="password-login" class="form-control">
                          </div>
                    ...
                    <div class="panel-body row">
                      <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input name="prenom" type="text" id="lastname" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="telephone">mdp <span class="require">*</span></label>
                          <input name="mdp" type="text" id="telephone" class="form-control">
                        </div>
