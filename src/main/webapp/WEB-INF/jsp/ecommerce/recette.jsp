...
<%@page import="com.example.demo.model.Recette" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><p>Montant : <%= mon.get(0).getMontant() %> <a style="color: blue ;" href="/actualiser">Actualiser</a></p></li>
          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="row product-list">
              ...
              <%
                ...
                list =(ArrayList<Recette>) session.getAttribute("listeRecette");
              ...
              <div class="col-md-3  ">
                <div class="product-item">
                  ...
                  <form action="ajoutPanierRecette" method="get"> 
                    <input type="hidden" name="idrecette" value="<%= list.get(i).getId() %>">     
                    <button type="submit">ajout dans le Panier</button>
                  </form>
