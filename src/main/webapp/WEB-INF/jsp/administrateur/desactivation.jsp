...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="/listeInfosParkingAdmin">
          <i class="bi bi-card-list"></i>
            ...
            <div class="card-body">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  list = (ArrayList<InfosParking>)session.getAttribute("listeInfosParkingAdmin");
                  ...
                  <tr>
                    <td>Parking <%= list.get(i).getNumeroparking()%></td>

			<%
			if (list.get(i).getType().equals("libre")){
					if (list.get(i).getEtat().equals("active")){
						
						
			%>
                    <td>
                        <form action="/updateParking" method="get">
                            <input type="hidden" name="id" value="<%= list.get(i).getId() %>">
                            <input type="submit" value="Desactivee">
                        </form>
                    </td>
