...
public class PDFGenerator {
	...
	public void generate(HttpServletResponse response) throws DocumentException, IOException {
		...
		Paragraph reservation = new Paragraph("Reservation numero : " +idReservation , font);
		reservation.setAlignment(Paragraph.ALIGN_CENTER);
		document.add(reservation);
		
		
		Paragraph parking = new Paragraph("Parking numero : "+numeroparking, font);
		parking.setAlignment(Paragraph.ALIGN_CENTER);
		document.add(parking);
		
	
		
		Paragraph vehicule = new Paragraph("Numero du Vehicule :"+idVehicule, font);
		vehicule.setAlignment(Paragraph.ALIGN_CENTER);
		document.add(vehicule);
		
		
		Paragraph Duree = new Paragraph("Durree : "+duree, font);
		Duree.setAlignment(Paragraph.ALIGN_CENTER);
		document.add(Duree);
		
		
		Paragraph Tarif = new Paragraph("Montant : "+montant, font);
